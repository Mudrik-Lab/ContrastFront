...
import {buildUrl, buildUrlForMultiSelect, rawTextToShow,} from "../../../Utils/functions";
    ...
    const {data, isLoading} = useQuery({
        ...
        queryFn: () =>
            getUncontrastFreeQueries({
                ...
                processing_domain_types:processing_domain_types,
                suppressed_stimuli_categories:suppressed_stimuli_categories,
                suppressed_stimuli_modalities: suppressed_stimuli_modalities,
                types,
                suppression_methods_types: suppression_methods_types,
