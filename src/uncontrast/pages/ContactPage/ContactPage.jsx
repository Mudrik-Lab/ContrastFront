...
export default function ContactPage() {
  // TODO: fix all links to new site
        ...
        <div className="w-full mx-auto text-base">
          <p className="text-justify">
            ...
            <ul className="list-disc ml-4">
              ...
              <li>
                If you want to find out if a paper is included in the database,
                so to know if you should add it, or to double-check our
              ...
              <svg
                ...
                <g clipPath="url(#clip0_641_5196)">
                  <path
                    ...
                    fill={chosen === "contact-us" ? "#159DEA" : "white"}
                  />
                </g>
              </svg>
              Contact Us
              ...
              <svg
                ...
                <g clipPath="url(#clip0_641_5206)">
                  <path
                    ...
                    fill={chosen === "new-query" ? "#159DEA" : "white"}
                  />
                </g>
              </svg>
              Suggest New Query
              ...
              <svg
                ...
                <g clipPath="url(#clip0_641_5188)">
                  <path
                    ...
                    fill={chosen === "vet-a-paper" ? "#159DEA" : "white"}
                  />
                </g>
              </svg>
              Vet A Paper
              ...
              <svg
                ...
                <g clipPath="url(#clip0_1186_9510)">
                  <path
                    ...
                    fill={chosen === "feedback" ? "#159DEA" : "white"}
                  />
                </g>
              </svg>
              Give Us Feedback
