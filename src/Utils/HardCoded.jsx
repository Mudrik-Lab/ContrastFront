...
export const uncontrastParametersOptions = [
    ...
    {value: "is_target_same_as_suppressed_stimulus", label: "is_target_same_as_suppressed_stimulus"},
    ...
    {value: "suppressed_stimuli_modality", label: "suppressed_stimuli_modality"},
